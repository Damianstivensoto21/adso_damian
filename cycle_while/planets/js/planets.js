/*
    Name exercise:exercise_planet
    Description:the exercise is about  enter a bulk and select a planet (earth,mars,jupiter) and calculate the gravity, calculate the total and end if bulk is negative
    Author:Damian stiven soto
